...
void FConnectionDrawingPolicy_AGSGraph::DrawPreviewConnector(const FGeometry& PinGeometry, const FVector2D& StartPoint, const FVector2D& EndPoint, UEdGraphPin* Pin)
{
...
void FConnectionDrawingPolicy_AGSGraph::DrawSplineWithArrow(const FVector2D& StartAnchorPoint, const FVector2D& EndAnchorPoint, const FConnectionParams& Params)
{
...
void FConnectionDrawingPolicy_AGSGraph::Internal_DrawLineWithArrow(const FVector2D& StartAnchorPoint, const FVector2D& EndAnchorPoint, const FConnectionParams& Params)
{
...
FVector2D FConnectionDrawingPolicy_AGSGraph::ComputeSplineTangent(const FVector2D& Start, const FVector2D& End) const
{
